...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    // BOM: Consulta com EntityGraph para evitar N+1
    ...
    // BOM: Consulta otimizada com múltiplos joins
    ...
    // BOM: Consulta com projeção para listagem
    ...
    // BOM: Consulta sem carregar blob (PDF) desnecessariamente
    ...
    // BOM: Consulta com índices otimizados
    ...
    // BOM: Consulta para estatísticas sem carregar entidades completas
